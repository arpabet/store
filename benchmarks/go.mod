module go.arpabet.com/store/benchmarks
...
require (
	...
	go.arpabet.com/store/providers/nutsdb v1.3.1
	go.arpabet.com/store/providers/pebble v1.3.1
	go.arpabet.com/store/providers/rosedb v1.3.1
